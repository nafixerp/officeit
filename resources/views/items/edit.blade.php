...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3">Edit Item: {{ $item->name }}</h1>
        ...
        <form action="{{ route('items.update', $item) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('purchase_rate') is-invalid @enderror" id="purchase_rate" name="purchase_rate" value="{{ old('purchase_rate', $item->purchase_rate) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('sales_rate') is-invalid @enderror" id="sales_rate" name="sales_rate" value="{{ old('sales_rate', $item->sales_rate) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('tax_rate_id') is-invalid @enderror" id="tax_rate_id" name="tax_rate_id">
                        ...
                        @foreach($taxRates as $taxRate)
                            <option value="{{ $taxRate->id }}" {{ old('tax_rate_id', $item->tax_rate_id) == $taxRate->id ? 'selected' : '' }}>{{ $taxRate->name }} ({{ $taxRate->rate }}%)</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('minimum_stock') is-invalid @enderror" id="minimum_stock" name="minimum_stock" value="{{ old('minimum_stock', $item->minimum_stock) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('brand') is-invalid @enderror" id="brand" name="brand" value="{{ old('brand', $item->brand) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('purchase_account_id') is-invalid @enderror" id="purchase_account_id" name="purchase_account_id">
                        ...
                        @foreach($accounts as $account)
                            <option value="{{ $account->id }}" {{ old('purchase_account_id', $item->purchase_account_id) == $account->id ? 'selected' : '' }}>{{ $account->code }} - {{ $account->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('sales_account_id') is-invalid @enderror" id="sales_account_id" name="sales_account_id">
                        <option value="">Select Account</option>
                        @foreach($accounts as $account)
                            <option value="{{ $account->id }}" {{ old('sales_account_id', $item->sales_account_id) == $account->id ? 'selected' : '' }}>{{ $account->code }} - {{ $account->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('inventory_account_id') is-invalid @enderror" id="inventory_account_id" name="inventory_account_id">
                        <option value="">Select Account</option>
                        @foreach($accounts as $account)
                            <option value="{{ $account->id }}" {{ old('inventory_account_id', $item->inventory_account_id) == $account->id ? 'selected' : '' }}>{{ $account->code }} - {{ $account->name }}</option>
                        @endforeach
                    </select>
