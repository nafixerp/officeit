...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Edit Asset: {{ $asset->name }}</h1>
        ...
        <form action="{{ route('assets.update', $asset) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="purchase_date" id="purchase_date" class="form-control @error('purchase_date') is-invalid @enderror" value="{{ old('purchase_date', $asset->purchase_date?->format('Y-m-d')) }}" required>
                    @error('purchase_date')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label for="purchase_value" class="form-label">Purchase Value <span class="text-danger">*</span></label>
                    <input type="number" step="0.01" name="purchase_value" id="purchase_value" class="form-control @error('purchase_value') is-invalid @enderror" value="{{ old('purchase_value', $asset->purchase_value) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="salvage_value" id="salvage_value" class="form-control @error('salvage_value') is-invalid @enderror" value="{{ old('salvage_value', $asset->salvage_value) }}">
                ...
                <div class="col-md-4">
                    ...
                    <select name="depreciation_method" id="depreciation_method" class="form-select @error('depreciation_method') is-invalid @enderror">
                        ...
                        <option value="units_of_production" {{ old('depreciation_method', $asset->depreciation_method) == 'units_of_production' ? 'selected' : '' }}>Units of Production</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="useful_life_years" id="useful_life_years" class="form-control @error('useful_life_years') is-invalid @enderror" value="{{ old('useful_life_years', $asset->useful_life_years) }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="depreciation_rate" id="depreciation_rate" class="form-control @error('depreciation_rate') is-invalid @enderror" value="{{ old('depreciation_rate', $asset->depreciation_rate) }}">
                    @error('depreciation_rate')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4">
                    <label for="location" class="form-label">Location</label>
                    <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', $asset->location) }}">
                ...
                <div class="col-md-4">
                    ...
                    <select name="assigned_to" id="assigned_to" class="form-select @error('assigned_to') is-invalid @enderror">
                        ...
                        @foreach($employees ?? [] as $employee)
                            <option value="{{ $employee->id }}" {{ old('assigned_to', $asset->assigned_to) == $employee->id ? 'selected' : '' }}>{{ $employee->full_name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-12">
                    ...
                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="3">{{ old('description', $asset->description) }}</textarea>
                    @error('description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
            </div>
            <div class="text-end mt-3">
                <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Update Asset</button>
            </div>
        </form>
    </div>
</div>
