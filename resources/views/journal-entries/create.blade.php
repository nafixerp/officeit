        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="narration" id="narration" class="form-control @error('narration') is-invalid @enderror" rows="2">{{ old('narration') }}</textarea>
            ...
            <table class="table table-bordered mb-0" id="linesTable">
                ...
                <tbody id="linesBody">
                    <tr class="line-row" data-index="0">
                        ...
                        <td><input type="number" name="lines[0][debit]" class="form-control form-control-sm debit" value="0" min="0" step="0.01" onchange="calculateTotals()"></td>
                        <td><input type="number" name="lines[0][credit]" class="form-control form-control-sm credit" value="0" min="0" step="0.01" onchange="calculateTotals()"></td>
                    ...
                    <tr class="line-row" data-index="1">
                        ...
                        <td><input type="number" name="lines[1][debit]" class="form-control form-control-sm debit" value="0" min="0" step="0.01" onchange="calculateTotals()"></td>
                        <td><input type="number" name="lines[1][credit]" class="form-control form-control-sm credit" value="0" min="0" step="0.01" onchange="calculateTotals()"></td>
