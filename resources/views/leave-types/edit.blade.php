        ...
        <form action="{{ route('leave-types.update', $leaveType) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="days_per_year" id="days_per_year" class="form-control @error('days_per_year') is-invalid @enderror" value="{{ old('days_per_year', $leaveType->days_per_year) }}" required>
                    @error('days_per_year')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-6 d-flex align-items-end">
                    <div class="form-check mb-3">
                        <input type="checkbox" name="is_paid" id="is_paid" class="form-check-input" value="1" {{ old('is_paid', $leaveType->is_paid) ? 'checked' : '' }}>
