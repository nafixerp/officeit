...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3">Customer Ledger: {{ $customer->name }}</h1>
    <a href="{{ route('customers.show', $customer) }}" class="btn btn-secondary">Back to Customer</a>
</div>

<div class="card mb-3">
    <div class="card-body">
        <form action="{{ route('customers.ledger', $customer) }}" method="GET" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="{{ route('customers.ledger', $customer) }}" class="btn btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
