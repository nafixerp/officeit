...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3">Edit Country: {{ $country->name }}</h1>
        ...
        <form action="{{ route('countries.update', $country) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control @error('iso_code') is-invalid @enderror" id="iso_code" name="iso_code" value="{{ old('iso_code', $country->iso_code) }}" maxlength="2" required>
                    @error('iso_code')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3 mb-3">
                    <label for="iso3_code" class="form-label">ISO3 Code</label>
                    <input type="text" class="form-control @error('iso3_code') is-invalid @enderror" id="iso3_code" name="iso3_code" value="{{ old('iso3_code', $country->iso3_code) }}" maxlength="3">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('phone_code') is-invalid @enderror" id="phone_code" name="phone_code" value="{{ old('phone_code', $country->phone_code) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('default_currency_id') is-invalid @enderror" id="default_currency_id" name="default_currency_id">
                        ...
                        @foreach($currencies as $currency)
                            <option value="{{ $currency->id }}" {{ old('default_currency_id', $country->default_currency_id) == $currency->id ? 'selected' : '' }}>{{ $currency->code }} - {{ $currency->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('tax_type') is-invalid @enderror" id="tax_type" name="tax_type">
                        ...
                        @foreach(['VAT', 'GST', 'SALES_TAX', 'NONE'] as $type)
                            <option value="{{ $type }}" {{ old('tax_type', $country->tax_type) == $type ? 'selected' : '' }}>{{ $type }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.0001" class="form-control @error('tax_percentage') is-invalid @enderror" id="tax_percentage" name="tax_percentage" value="{{ old('tax_percentage', $country->tax_percentage) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('tax_registration_format') is-invalid @enderror" id="tax_registration_format" name="tax_registration_format" value="{{ old('tax_registration_format', $country->tax_registration_format) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('invoice_number_format') is-invalid @enderror" id="invoice_number_format" name="invoice_number_format" value="{{ old('invoice_number_format', $country->invoice_number_format) }}">
                    @error('invoice_number_format')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-4 mb-3">
                    <label for="date_format" class="form-label">Date Format</label>
                    <input type="text" class="form-control @error('date_format') is-invalid @enderror" id="date_format" name="date_format" value="{{ old('date_format', $country->date_format) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('financial_year_format') is-invalid @enderror" id="financial_year_format" name="financial_year_format" value="{{ old('financial_year_format', $country->financial_year_format) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('address_style') is-invalid @enderror" id="address_style" name="address_style" value="{{ old('address_style', $country->address_style) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('accounting_rules_profile') is-invalid @enderror" id="accounting_rules_profile" name="accounting_rules_profile" value="{{ old('accounting_rules_profile', $country->accounting_rules_profile) }}">
