        ...
        <form action="{{ route('companies.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('tax_registration_number') is-invalid @enderror" id="tax_registration_number" name="tax_registration_number" value="{{ old('tax_registration_number') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control @error('financial_year_start') is-invalid @enderror" id="financial_year_start" name="financial_year_start" value="{{ old('financial_year_start') }}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('invoice_prefix') is-invalid @enderror" id="invoice_prefix" name="invoice_prefix" value="{{ old('invoice_prefix') }}">
