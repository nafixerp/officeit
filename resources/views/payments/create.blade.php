        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" name="exchange_rate" id="exchange_rate" class="form-control @error('exchange_rate') is-invalid @enderror" value="{{ old('exchange_rate', 1) }}" step="0.000001" min="0">
                ...
                <div class="col-md-4" id="bankAccountField" style="{{ old('payment_mode', '') == 'Cash' || old('payment_mode', '') == '' ? 'display:none;' : '' }}">
