        ...
        <form action="{{ route('projects.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('budget') is-invalid @enderror" id="budget" name="budget" value="{{ old('budget', '0.00') }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                        ...
                        @foreach(['PLANNED', 'IN_PROGRESS', 'ON_HOLD', 'COMPLETED', 'CANCELLED'] as $status)
                            <option value="{{ $status }}" {{ old('status') == $status ? 'selected' : '' }}>{{ str_replace('_', ' ', $status) }}</option>
                        @endforeach
                    </select>
