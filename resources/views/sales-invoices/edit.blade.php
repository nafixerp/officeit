            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <select name="invoice_type" id="invoice_type" class="form-select" required>
                        <option value="Cash" {{ old('invoice_type', $invoice->invoice_type) == 'Cash' ? 'selected' : '' }}>Cash</option>
                ...
                <div class="col-md-3">
                    ...
                    <select name="sales_order_id" id="sales_order_id" class="form-select">
                        ...
                        @foreach($salesOrders ?? [] as $so)
                            <option value="{{ $so->id }}" {{ old('sales_order_id', $invoice->sales_order_id) == $so->id ? 'selected' : '' }}>#{{ $so->order_number }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="country" id="country" class="form-control" value="{{ old('country', $invoice->country) }}">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <td>
                            <select name="items[{{ $idx }}][item_id]" class="form-select form-select-sm">
                                ...
                                @foreach($items ?? [] as $item)
                                    <option value="{{ $item->id }}" {{ $invItem->item_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </td>
                        ...
                        <td>
                            <select name="items[{{ $idx }}][tax_rate_id]" class="form-select form-select-sm tax-rate" onchange="calculateRow(this)">
                                ...
                                @foreach($taxRates ?? [] as $tax)
                                    <option value="{{ $tax->id }}" data-rate="{{ $tax->rate }}" {{ $invItem->tax_rate_id == $tax->id ? 'selected' : '' }}>{{ $tax->name }} ({{ $tax->rate }}%)</option>
                                @endforeach
                            </select>
                        </td>
