...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3">Edit Bank Account: {{ $bankAccount->bank_name }}</h1>
        ...
        <form action="{{ route('bank-accounts.update', $bankAccount) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('account_holder_name') is-invalid @enderror" id="account_holder_name" name="account_holder_name" value="{{ old('account_holder_name', $bankAccount->account_holder_name) }}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select @error('currency_id') is-invalid @enderror" id="currency_id" name="currency_id">
                        ...
                        @foreach($currencies as $currency)
                            <option value="{{ $currency->id }}" {{ old('currency_id', $bankAccount->currency_id) == $currency->id ? 'selected' : '' }}>{{ $currency->code }} - {{ $currency->name }}</option>
                        @endforeach
                    </select>
