...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3">Create Tax Rate</h1>
        ...
        <form action="{{ route('tax-rates.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('tax_profile_id') is-invalid @enderror" id="tax_profile_id" name="tax_profile_id" required>
                        ...
                        @foreach($taxProfiles as $profile)
                            <option value="{{ $profile->id }}" {{ old('tax_profile_id') == $profile->id ? 'selected' : '' }}>{{ $profile->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" step="0.0001" class="form-control @error('rate') is-invalid @enderror" id="rate" name="rate" value="{{ old('rate') }}" required>
