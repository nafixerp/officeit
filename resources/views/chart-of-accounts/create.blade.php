        ...
        <form action="{{ route('chart-of-accounts.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id">
                        ...
                        @foreach($parentAccounts as $parent)
                            <option value="{{ $parent->id }}" {{ old('parent_id') == $parent->id ? 'selected' : '' }}>{{ $parent->code }} - {{ $parent->name }} ({{ $parent->type }})</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('sub_type') is-invalid @enderror" id="sub_type" name="sub_type" value="{{ old('sub_type') }}">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="is_group" name="is_group" value="1" {{ old('is_group') ? 'checked' : '' }}>
