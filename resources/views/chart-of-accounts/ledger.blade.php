...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h1 class="h3">Ledger: {{ $account->code }} - {{ $account->name }}</h1>
    <a href="{{ route('chart-of-accounts.index') }}" class="btn btn-secondary">Back to Chart of Accounts</a>
</div>

<div class="card mb-3">
    <div class="card-body">
        <form action="{{ route('chart-of-accounts.ledger', $account) }}" method="GET" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex align-items-end">
                ...
                <a href="{{ route('chart-of-accounts.ledger', $account) }}" class="btn btn-outline-secondary">Reset</a>
            </div>
        </form>
    </div>
</div>
