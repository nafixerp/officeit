            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="employee_id_number" id="employee_id_number" class="form-control @error('employee_id_number') is-invalid @enderror" value="{{ old('employee_id_number', $employee->employee_id_number) }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        @if($employee->photo)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $employee->photo) }}" alt="Current photo" style="width:80px;height:80px;border-radius:50%;object-fit:cover;">
                            </div>
                        @endif
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="visa_details" id="visa_details" class="form-control @error('visa_details') is-invalid @enderror" rows="3">{{ old('visa_details', $employee->visa_details) }}</textarea>
                        @error('visa_details')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-3">
                        <label for="mobile" class="form-label">Mobile</label>
                        <input type="text" name="mobile" id="mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile', $employee->mobile) }}">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="2">{{ old('address', $employee->address) }}</textarea>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" name="basic_salary" id="basic_salary" class="form-control @error('basic_salary') is-invalid @enderror" value="{{ old('basic_salary', $employee->basic_salary) }}" required>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="bank_account_number" id="bank_account_number" class="form-control @error('bank_account_number') is-invalid @enderror" value="{{ old('bank_account_number', $employee->bank_account_number) }}">
                    @error('bank_account_number')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="col-md-3">
                    <label for="bank_iban" class="form-label">Bank IBAN</label>
                    <input type="text" name="bank_iban" id="bank_iban" class="form-control @error('bank_iban') is-invalid @enderror" value="{{ old('bank_iban', $employee->bank_iban) }}">
